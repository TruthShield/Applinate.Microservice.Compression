...
class Build : NukeBuild
{
    ...
    Target Pack => _ => _
      ...
      {
          DotNetPack(s => s
            .SetProject(Solution.GetProject("Applinate.Microservice.Compression.Abstractions"))
            .SetConfiguration(Configuration)
            .EnableNoBuild()
            .EnableNoRestore()
            .SetVersion(Version)
          ...
          DotNetPack(s => s
            .SetProject(Solution.GetProject("Applinate.Microservice.Compression.Core"))
            .SetConfiguration(Configuration)
            .EnableNoBuild()
            .EnableNoRestore()
            .SetVersion(Version)
          ...
          DotNetPack(s => s
            .SetProject(Solution.GetProject("Applinate.Microservice.Compression.None"))
            .SetConfiguration(Configuration)
            .EnableNoBuild()
            .EnableNoRestore()
            .SetVersion(Version)
